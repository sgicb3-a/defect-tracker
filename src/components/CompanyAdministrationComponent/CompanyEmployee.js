...
import { MDBNavbar, MDBNavbarBrand, MDBNavbarNav, MDBFooter, MDBNavbarToggler, MDBCollapse, MDBMask, MDBRow, MDBCol, MDBBtn,   MDBView, MDBContainer, MDBFormInline } from "mdbreact";
        ...
        <div className="table-operations">
          <Row>
            <Col span={19}>
              ...
              <Button onClick={this.clearAll} style={{ marginLeft: "15px" }}>More View</Button>
...
<MDBFooter id="container">
      <div className="footer-copyright text-center py-3">
        <MDBContainer fluid>
          &copy; {new Date().getFullYear()} Copyright: <a href=""> SGIC </a>
        </MDBContainer>
      </div>

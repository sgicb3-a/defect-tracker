...
function createData(severity, desc, icon, color, edit, del) {
  return { severity, desc, icon, color, edit, del };
}

const rows = [createData("Low", "Defect impact is low")];
...
export default function SeverityConfiguration() {
              ...
              <TableRow key={row.severity}>
                ...
                <TableCell align="right">
                  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="85%" cy="50%" r="12" fill="green" />
                  </svg>
                </TableCell>
                <TableCell align="right">
                  <Fab
